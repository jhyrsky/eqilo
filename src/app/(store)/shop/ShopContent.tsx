            ...
            <AnimatePresence mode="popLayout">
              {activeProducts.map((product, index) => (
                <motion.div
                  ...
                  className="h-full"
                >
                  <Card className="h-full flex flex-col overflow-hidden transition-all hover:shadow-xl border-border/50 hover:border-primary/40 group bg-card text-card-foreground">
